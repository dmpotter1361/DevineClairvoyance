<#
    Reproducible build for Devine Clairvoyance.
...
$proj = Join-Path $root "DevineClairvoyance.csproj"
$wxs  = Join-Path $root "installer\Package.wxs"
$msi  = Join-Path $root "installer\DevineClairvoyance-$Version-x64.msi"
